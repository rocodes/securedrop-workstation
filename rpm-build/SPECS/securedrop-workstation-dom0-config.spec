...
Source0:	securedrop-workstation-dom0-config-0.6.1.tar.gz
...
%prep
%setup -n securedrop-workstation-dom0-config-0.6.1
...
%changelog
* Tue 31 May 2022 SecureDrop team <securedrop@freedom.press> - 0.6.1
